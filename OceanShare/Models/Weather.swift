...
struct Weather {
    ...
    init(weatherData: JSON) {
        ...
        sunrise = NSDate(timeIntervalSince1970: weatherData["sys"]["sunrise"].double!) // TimeInterval
        sunset = NSDate(timeIntervalSince1970: weatherData["sys"]["sunset"].double!) // TimeInterval
